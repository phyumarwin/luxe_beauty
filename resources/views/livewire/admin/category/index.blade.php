        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $category->id }}</td>
                                <td>
                                    <button wire:click="$set('category_id', {{ $category->id }})" wire:loading.attr="disabled" class="btn btn-link">
                                        {{ $category->name }}
                                    </button>
                                </td>
                    ...
                    @if($category_id) <!-- Check if a category is selected -->
                        <h4>Subcategories for {{ $categories->find($category_id)->name }}</h4>
                        <ul>
